# Design Document: ION-DTN Cislunar Demonstration — Master
...
The following phase-specific design documents contain deployment details, CLA usage, and testing considerations unique to each phase:

- [Phase 1 — Terrestrial Testbed Design](../phase1-terrestrial/design.md)
- [Phase 2 — CubeSat Design](../phase2-cubesat/design.md) — conditional on CubeSat host
- [Phase 3 — Cislunar Payload Design](../phase3-cislunar/design.md) — conditional on ESA ARTES approval
