...
The following phase-specific requirements documents contain the requirements unique to each phase:

- [Phase 1 — Terrestrial Testbed Requirements](../phase1-terrestrial/requirements.md) (Requirements 1, 2, 3, 20)
- [Phase 2 — CubeSat Requirements](../phase2-cubesat/requirements.md) (Requirements 4, 5, 6) — conditional on CubeSat host
- [Phase 3 — Cislunar Payload Requirements](../phase3-cislunar/requirements.md) (Requirements 7, 8) — conditional on ESA ARTES approval
